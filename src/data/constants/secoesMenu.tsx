import { IconAppWindow, IconArrowsLeftRight, IconColorSwatch, IconDatabase, IconDatabaseImport, IconDimensions, IconForms, IconLetterCase, IconLock, IconMathGreater, IconMenu, IconNumbers, IconPin, IconRefreshAlert, IconSection, IconShoppingCart, IconTextColor, IconUsers, IconX } from "@tabler/icons-react";
...
export const secoes = [
    ...
    },
    {
        ...
        itens: [
            ...
            { titulo: "Formulário 1", url: "/outros/formularioId1", tag: "useId", icone: <IconForms /> },
            { titulo: "Formulário 2", url: "/outros/formularioId2", tag: "useId", icone: <IconForms /> },
        ]
    }
];
